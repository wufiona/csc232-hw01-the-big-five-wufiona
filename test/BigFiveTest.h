 ...
 * @file   BigFiveTest.h
 * @brief  Google Test specification for unit testing a Point Big Five implementations.
 */

#ifndef HW01_BIG_FIVE_TEST_H
#define HW01_BIG_FIVE_TEST_H
...
namespace {
    class BigFiveTest : public ::testing::Test {
    protected:
        BigFiveTest() {
            // You can do set-up work for each test here...
        }

        ~BigFiveTest() override {
